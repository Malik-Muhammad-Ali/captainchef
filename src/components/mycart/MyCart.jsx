        ...
        >
          ...
          <Typography
            ...
            sx={{
              ...
              ml: language === "ar" ? "8px" : "16px", // Adjust spacing based on language
              mr: language === "ar" ? "16px" : "8px", // Ensure symmetry for Arabic
              textAlign: "center",
            }}
          >
            ...
            {cartData?.map((product, index) => (
              ...
              >
                ...
                <Box
                  sx={{
                    display: "grid",
                    gridTemplateColumns: "50px auto", // 50px for the image and remaining space for text
                    gap: 1,
                    alignItems: "center",
                  }}
                >
                  ...
                  <Box sx={{ textAlign: "center" }}>
                    ...
                    <Typography
                      ...
                      sx={{
                        fontWeight: "bold",
                        marginBottom: "4px",
                        ml: language == "ar" ? "25px" : "25px", // Adjust spacing based on language
                        mr: language == "ar" ? "25px" : "80px", // Ensure symmetry for Arabic
                        textAlign: "start",
                      }}
                    >
                      {language === "en"
                    ...
                    <Typography
                      ...
                      sx={{
                        color: "#666",
                        ml: language == "ar" ? "35px" : "22px", // Adjust spacing based on language
                        mr: language == "ar" ? "0px" : "15px", // Ensure symmetry for Arabic                        textAlign: "start",
                      }}
                    >
                ...
                <Typography variant="body1" sx={{ color: "#D92531" }}>
                  {product?.delivery_type === "delivery" &&
                    (language === "en" ? "Home Delivery" : "توصيل إلى المنزل")}
