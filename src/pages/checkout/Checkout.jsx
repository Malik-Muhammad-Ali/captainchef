...
`,
    ...
    {
      id: "visa",
      label: { ar: "الدفع باستخدام بطاقة فيزا", en: "Pay with Visa Card" },
...
`,
    },
    {
      id: "discover",
      label: {
        ar: "الدفع باستخدام بطاقة ديسكفر",
        en: "Pay with Discover Card",
      },
      ...
      >
        <Box
          sx={{
            ...
            marginInlineStart: { lg: "-100px", xs: "0" }, // Automatically adjusts for RTL
          }}
        >
          <Box
            sx={{
          ...
          {/* <TextField
                  ...
                  InputLabelProps={{
                    sx: {
                      ...
                      top: "-10px",
                      left: isArabic
                        ? { lg: "500px", md: "420px", sm: "310px", xs: "285px" }
                        : "16px",
                      fontSize: "14px",
                      background: "white",
                      padding: "0 4px",
              ...
              <Box component="form" noValidate autoComplete="off">
                ...
                >
                  ...
                  <Typography sx={{ marginLeft: "8px" }}>
                    {isArabic
                      ? "نحن نحمي معلومات الدفع الخاصة بك باستخدام التشفير لتوفير أمان على مستوى البنوك."
